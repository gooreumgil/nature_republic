var changeImg = {
    logo: {
        origin: '/static/imgs/NATURE%20REPUBLIC_fullback.png',
        over: '/static/imgs/NATURE%20REPUBLIC_white_back.png',
    },
    login: {
        origin: '/static/imgs/login_fullback.png',
        over: '/static/imgs/top_icon1.png',
    },
    cart: {
        origin: '/static/imgs/cart_fullback.png',
        over: '/static/imgs/top_icon2.png',
    },
    cart_number: {
        origin: '/static/imgs/cart_number_fullback.png',
        over: '/static/imgs/cart_number.png'
    },
    search: {
        origin: '/static/imgs/search_fullback.png',
        over: '/static/imgs/top_icon3.png'
    }
};
